...
public class Tarea {
   ...
   private int estado;
    ...
    public String toString() {
        return "Tarea{" + "idTarea=" + idTarea + ", equipoMiembros=" + equipoMiembros.getIdEquipoMiembros() + ", nombr=" + nombr + ", fechaCreacion=" + fechaCreacion + ", fechaCierre=" + fechaCierre + ", estado=" + estado + '}';
    }
